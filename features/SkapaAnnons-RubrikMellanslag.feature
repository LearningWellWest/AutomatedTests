...
Egenskap: Det ska inte gå att skapa en annons med bara mellanslag i rubriken
...
Scenario: Inloggad Skapa annons med många tecken
	...
	Så ska felmedelandet "Rubriken måste innehålla siffror eller bokstäver" visas
